...
test_that("Testing attendance example", 
          { 
            ...
            expect_equal(round(M.attendance$residuals_deviance,3), 377.441)
          })
...
test_that("Testing cottonbolls example",
          { data(cottonbolls)
            ...
            expect_equal(round(M.bolls$residuals_deviance,1), 125.3)
          })
...
test_that("Testing fish example",
          { data(fish)
            ...
            expect_equal(round(M.fish$residuals_deviance,1), 59.5)
          })
